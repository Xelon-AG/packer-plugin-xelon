module github.com/Xelon-AG/packer-plugin-xelon

go 1.26

require (
	github.com/Xelon-AG/xelon-sdk-go v1.8.0
...
// added by packer-sdc fix as noted in github.com/hashicorp/packer-plugin-sdk/issues/187
